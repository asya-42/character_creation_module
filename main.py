...
from graphics_art.start_game_banner import run_screensaver
...
def special(char_name: str, char_class: str) -> str:
    """Describe the use of special skills."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Describe and approve choosen game character."""
    approve_choice: str = ''
    char_class: str = ''
...
def main() -> None:
    """Greet and choose a  game character."""
